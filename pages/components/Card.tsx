...
const Card = (props: Props) => {
  return (
    <div className='w-[90%] min-h-24 border-2 border-green-200 outline-none mx-auto rounded-xl grid grid-cols-3 grid-rows-2 items-center justify-center text-center hover:bg-green-200 text-green-900 hover:scale-x-105 transition-all cursor-pointer'>
